...
v806=v613['markerTexture'];
if(v806&&v806._reglType==='framebuffer'){
v806=v806.color[0];
}
v807=v806._texture;
v8.uniform1i(markerTexture.location,v807.bind());
v808=v613['opacity'];
if(!v612||v809!==v808){
v809=v808;
v8.uniform1f(opacity.location,v808);
}
v810=v613['elements'];
v811=null;
v812=v9(v810);
...
v267=a0['markerTexture'];
if(v267&&v267._reglType==='framebuffer'){
v267=v267.color[0];
}
v268=v267._texture;
v8.uniform1i(markerTexture.location,v268.bind());
v269=a0['opacity'];
v8.uniform1f(opacity.location,v269);
v270=a0['elements'];
v271=null;
v272=v9(v270);
if(v272){
